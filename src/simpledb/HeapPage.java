...
public class HeapPage implements Page {
	 ...
	 */
	public Tuple getTuple(int entryID) throws UnsupportedOperationException {
		// some code goes here
		int k=entryCount();
		if(entryID<k)
		{
		...
		int i=tupleLocation(entryID);
		DataInputStream in = new DataInputStream(new ByteArrayInputStream(data, i, data.length-i));
	...
	//HeapPage
		...
		Iterator<Tuple> i=a.iterator();
		return i;
		
	//hrow new UnsupportedOperationException("Implement this");
	}
	...
	public void deleteTuple(Tuple t) throws DbException {
		...
		int eid=t.getRecordId().tupleno();	
		saveTupleLocation(eid,-1);
	 ...
	 */
	public void addTuple(Tuple t) throws UnsupportedOperationException,DbException {
		// some code goes here
		byte[] b = toByteArray(t);
		if(freeSpaceSize() < b.length + 4)
          {
	             throw new DbException("dbexcption ");
           }
          else
          {
		...
		saveEntryCount( entryCount());
		saveTupleLocation(entryCount(), tupleLocation(entryCount()));
		RecordId rid=new RecordId(getId(), entryCount());
	 ...
	 */
	protected int entryCount() throws UnsupportedOperationException {
		// some code goes here
	 ...
	 */
	protected int tupleLocation(int entryID)throws UnsupportedOperationException {
		// some code goes here
